...
// WORLD MDPs
boost::shared_ptr<WorldMDP> createWorldMDP(boost::shared_ptr<RNG> rng, const Point2D &dims, bool beliefMDP, unsigned int numBeliefs = 1, unsigned int numBins = 1, ModelUpdateType updateType = BAYESIAN_UPDATES);
